...
import {Box, Typography, Stack, Rating, List, ListItem, Button} from "@mui/material";
...
const ColorBox = styled(Box)`
    ...
    align-items:center;
    cursor: pointer;
    color: ${(props:any) => props.selected? "white": "rgba(0,0,0,0)"} !important;
...
const InformationSection = () => {
    ...
    return(
        <Box>
            <Typography variant="h4" component="h2">Remax Bluetooth Headphone RB-725HB</Typography>
            ...
            <Typography variant="h4" component="h4" mt={2}>Rs 6,790</Typography>
            <ItemFeatures/>
            <ColorSelector/>
            <GoToCart/>
...
const ColorSelector = () => {
    ...
    return(
        <Box mt={2}>
            <Typography variant="h6" component="h6">COLORS</Typography>
            ...
            <Typography sx={{fontSize: "10px", color: "grey", cursor: "pointer", padding: "0 5px"}} mt={1} onClick={() => setColor("")}>CLEAR</Typography>
        </Box>
    );
}
...
const GoToCart = () => {
    ...
    return(
        <Stack direction="row" spacing={2} mt={2}>
            <Box>
                <Stack direction="row">
                    <Stack direction="row" sx={{width: "50px", height: "50px", background:"white", color:"black", border: "1px solid rgba(0,0,0,0.2)", alignItems: "center", justifyContent:"center"}}>
                        <Typography sx={{fontSize: "25px", fontWeight: "700"}}>{itemNo}</Typography>
                    </Stack>
                    <Stack direction="column">
                        <PlusMinusBtn variant="outlined" onClick={() => setItemNo(itemNo + 1)}>
                        <Typography>+</Typography>
                        </PlusMinusBtn>
                        <PlusMinusBtn variant="outlined" onClick={() => handleSubstraion()}>
                        <Typography>-</Typography>
                        </PlusMinusBtn>
                    </Stack>
                </Stack>
